...
[.bordershadow]
image::parksmap-view-logs-link.png[Resources 탭에서 Pod 옆에 표시된 View Logs 링크,link=self,window=blank]

**View Logs** 링크를 클릭하여 **Pod**의 로그를 확인합니다:

[.bordershadow]
image::parksmap-logging-console-logs.png[웹 콘솔에서 확인한 parksmap Pod의 컨테이너 로그,link=self,window=blank]
